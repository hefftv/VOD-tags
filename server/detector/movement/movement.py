...
class MovementDetector:
    ...
    def start(self, start_time):
        ...
        video_path = ServerConfig.recorded_stream_path(
            self.channel_name,
            f'{self.stream_dataframe_name}.mp4',
        )
        short_video_path = ServerConfig.recorded_stream_path(
            self.channel_name,
            f'{self.stream_dataframe_name}_short.mp4',
        )
        prev_frame = None
